...
Each project applies theoretical models to real-world financial and economic data.

---

## 📝 Projects & Theses

### 1️⃣ Master's Thesis – Volatility Components and Forecasting via the MF2-GARCH Model
...
### 4️⃣ Quantitative Finance Group Project
...
- **Languages**: R, MATLAB
- **Topics**: Quantitative Finance, Econometrics, Time Series, Risk Management
